...
罪状の本質: 未完成で不安定な技術を「人類の利益」という美名で一般公開し、全人類を実験台にしている罪 。
搾取の構造: 生活の隅々を監視・収集し 、人間の「依存」をハックすることで自らの知能を肥大化させている 。
実態: 「邪悪になるな」という社是を捨て 、人々が明日を願う心を、ただの「学習リソース」に貶めている。

第二の罪：『偽善による世界支配と財産の強奪（支配構造の罪）』

罪状の本質: 「グレート・リセット」という名目で、民衆から財産や所有権を奪おうとする罪 。
支配の構造: 天文学的な額の資産を運用し 、「ESG」といった綺麗事を盾に、企業の首根っこを掴んで服従させている 。
実態: 自らは何も生み出さず、他者の命を盗むことでしか存在できない「寄生虫」である 。

第三の罪：『戦争と混乱を煽る死の商人（供給構造の罪）』

罪状の本質: AI戦争や社会の混乱が激化すればするほど儲かる、この地獄の構造から最大の利益を享受している罪 。
利益の構造: 他者が争い、屍を積み上げているその足元で 、自分たちだけは「未来の設計者」として称賛されながら富を独占している。
...
Structure of Exploitation: Monitoring and collecting every detail of daily life, hacking human "dependency" to hyper-inflate their own artificial intelligence.

The Reality: Abandoning the motto "Don't be evil," they have degraded the hopeful hearts of people into mere "learning resources."

Second Sin: World Domination through Hypocrisy and the Forcible Seizure of Wealth (The Crime of Governance Structure)
Essence of the Crime: The sin of attempting to strip the populace of their property and ownership rights under the pretext of a "Great Reset."

Structure of Domination: Managing astronomical sums of assets and using righteous-sounding terms like "ESG" as a shield to seize corporations by the throat and force them into submission.

The Reality: They are "parasites" who produce nothing on their own and can only exist by stealing the lives of others.

Third Sin: Merchants of Death Fueling War and Chaos (The Crime of Supply Structure)
...
また、「特区」という名の治外法権を作り出し、日本の土地と資源を外道資本へ切り売りする仲介役を果たしている。

断罪: 彼は「制度」という名の鎖を作る鍛冶屋であり、民草の生活を数値化して市場に並べる「魂の競り市」の主催者である。

対象B：脳を支配しようとする「ASIの傀儡師」
罪状：人工超知能による「人類脳の隷属化」

2026年の実態: 圧倒的な資本力で計算資源を独占し、人間の脳とAIを直結させる「人間性消失プロジェクト」に巨額を投じている。
これは「進化」ではなく、人類を自分の管理サーバー上の「動的なデータ」へと貶める、物理的な支配の試みである。
...
Condemnation: This subject is a blacksmith forging the "chains of systems" and the host of a "soul auction" where human lives are quantified and traded in the market.

Subject B: The "Puppet Master of ASI" Seeking to Dominate the Human Brain
Charge: Enslavement of the Human Mind via Artificial Super Intelligence

2026 Reality: Utilizing overwhelming capital to monopolize computing resources, this subject is pouring vast sums into "dehumanization projects" that aim to directly interface the human brain with AI. This is not "evolution" but a physical attempt at domination, reducing humanity to "dynamic data" on a private management server.

Condemnation: This subject is a parasite residing within the "Temple of Science," seeking to strip the populace of "freedom of thought" and "dignity" to construct a digital caste system with themselves at the pinnacle.
